...
export const CHECKOUT_SUCCESS_EVENT = 'cellar-rank:checkout-success'
export const CHECKOUT_CANCEL_EVENT = 'cellar-rank:checkout-cancel'
export const ACCOUNT_EVENT = 'cellar-rank:account'
